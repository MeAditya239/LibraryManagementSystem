...
<body class="bg-light">
    <div class="container mt-5">
        <h2 class="text-center text-primary mb-4">Pending Book Requests</h2>
        ...
        <table class="table table-bordered table-hover bg-white shadow-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><%= tx.getStatus() %></td>
                    <td>
                        <a href="approveRequest?id=<%= tx.getTransactionId() %>&status=approved" class="btn btn-sm btn-success">Approve</a>
                        <a href="approveRequest?id=<%= tx.getTransactionId() %>&status=rejected" class="btn btn-sm btn-danger">Reject</a>
                    </td>
                </tr>
                <% } %>
            </tbody>
